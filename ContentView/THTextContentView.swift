...
//  ScrollViewContent
//
//  Created by Seong ho Hong on 2018. 2. 6..
...
extension THTextContentView: ContentViewDelegate {
    public func setContentInfo() {
        let textContent = info as! [Dictionary<String, String>]
        let title = textContent[0]["title"]
        let link = textContent[1]["link"]
        let text = textContent[2]["text"]
